 ...
 * @author jules
 */
public class Login_form_patient extends javax.swing.JFrame {
    ...
    public Login_form_patient(UserList U) {
        UL=U;
        initComponents(); 
        //Centrer la forme
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ConPatient.Verify_Login(email, password);
        //new Register_form_employee().setVisible(true);
